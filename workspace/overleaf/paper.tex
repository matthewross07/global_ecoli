...
\correspondingauthor{[TBD]}{[corresponding author contact]}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig_global_distribution_density.png}
\caption{Global density of freshwater fecal indicator bacteria observations, aggregated into hexagonal bins and shaded on a logarithmic scale. Monitoring is heavily concentrated in the United States and Europe, with sparse coverage across most of the Global South and an almost complete absence over Russia and China. Observations for India include fecal and total coliform, but exclude E. coli.}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig_sampling_frequency_mismatch.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig_actionability_gap.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig_high_frequency_case_studies.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{fig_global_safety_summary.png}
